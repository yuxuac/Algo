    ...
    public class TrashCode
    {
        public void CodeSnippet()
        {
             /*
                ...
                Expected:
                [8,1,5,4,3,2,1,1,0,0]
                var array = DailyTemperaturesAlgo.GetInput();
            var result = DailyTemperaturesAlgo.DailyTemperatures(array);
            ...
            */
            ...
            OpenLockSolution.Test();

            string str = "1234";
            var val = int.Parse(str[0].ToString());
            var str1 = str.Substring(0, 0) + 2 + str.Substring(1);
            var str2 = str.Substring(0, 3) + 5 + str.Substring(4);

            var array = DFS_NumberOfIslands.Initialize();
            DFS_NumberOfIslands.NumIslands(array);
